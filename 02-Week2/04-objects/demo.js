...
//Accessing Properties
    ...
    //Nested properties
        ...
        console.log("Adrian", person['address']['state'][0]['town'][0])
        console.log("Fatima",person.address.state[0].town[0])
        console.log("Tani",person.address.state[0].town[0])
        console.log("Jonathon",person.address.state[0]['town'][0]);

    //add
        person.favoriteColor = 'Purple'
        console.log(person)
        person['favoriteFood'] = 'chips' // ??????
...
//Object.keys(object) // this will return an array with all of the keys as strings

const keyNamrs = Object.keys(person)
